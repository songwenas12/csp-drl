...
{
	//std::cout << "Doing MKL_GeMM1, transa=" << transa << ", transb=" << transb << std::endl;
	cblas_sgemm(Layout, transa, transb, m, n, k, alpha, a, lda, b, ldb, beta, c, ldc);
	//std::cout << "MKL_GeMM1 done." << std::endl;
}
...
{
	//std::cout << "Doing MKL_GeMM2, transa="<<transa<<", transb="<< transb << std::endl;
	cblas_dgemm(Layout, transa, transb, m, n, k, alpha, a, lda, b, ldb, beta, c, ldc);
	//std::cout << "MKL_GeMM2 done." << std::endl;
}
