...
protected:
	...
	virtual void InitCPUWeight(HyperGraphStruct* graph) = 0;
...
protected:
	...
	virtual void InitCPUWeight(HyperGraphStruct* graph) override;	//<ADD>: added for CSP
};
...
protected:
	virtual void InitCPUWeight(GraphStruct* graph) override;
	virtual void InitCPUWeight(HyperGraphStruct* graph) override;
};
...
template<typename mode, typename Dtype>
class SubgraphMsgPass_edge : public IMsgPass<mode, Dtype>
{
public:
	static std::string StrType()
	{
		return "SubgraphMsgPass_edge";
	}
	...
	*/
	...
	SubgraphMsgPass_edge(std::string _name, bool _average = false) : IMsgPass<mode, Dtype>(_name, _average) {}
protected:
	virtual void InitCPUWeight(GraphStruct* graph) override;
	virtual void InitCPUWeight(HyperGraphStruct* graph) override;
};
