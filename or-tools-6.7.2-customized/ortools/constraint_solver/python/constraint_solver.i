...
namespace std {
	%template(testMap) map<int, vector<int>>;
	%template(testVecVec) vector<vector<int>>;
}
%shared_ptr(operations_research::ConstrStruct);
...
PY_CONVERT_HELPER_PTR(Solver);
//PY_CONVERT_HELPER_PTR(ConstrStruct);
PY_CONVERT_HELPER_PTR(IMasterDRL);
//PY_CONVERT_HELPER_PTR(IClass);
...
PY_CONVERT(Solver);
//PY_CONVERT(ConstrStruct);
PY_CONVERT(IMasterDRL);
//PY_CONVERT(IClass)
#undef PY_CONVERT
...
%unignore Solver::AddConstraint_Return;
...
%unignore Solver::GetName;

// Solver: Decomposed or specialized Solve() API.
%unignore Solver::NewSearch;
%unignore Solver::NextSolution;
%unignore Solver::TestMap;
%unignore Solver::TestVector;
%unignore Solver::TestConstr;
...
%unignore Solver::CHOOSE_MIN_Q;
%unignore Solver::CHOOSE_MIN_Q_TEST;
%unignore Solver::CHOOSE_MIN_SIZE_OVER_DDEG;
%unignore Solver::CHOOSE_MIN_SIZE_OVER_TDEG;
...
%unignore Solver::DRLPhase;
%unignore Solver::WARM_UP;
%unignore Solver::TRAINING;
%unignore Solver::TESTING;

%unignore ConstrStruct;
%unignore ConstrStruct::~ConstrStruct;
%unignore IMasterDRL;
%unignore IMasterDRL::destroy;
%unignore IMasterDRL::checkIfCaseInPool;
%unignore IMasterDRL::retrieveConstrStruct;

%unignore Solver::printVars;
%unignore Solver::setVarConstrList;
%unignore Solver::CreateConstrStruct;
%unignore Solver::NextSolution_Test;
%unignore Solver::NextSolution_DRL;
%unignore Solver::getNumDecisions;
%unignore Solver::getRealSolvingTime;
%unignore Solver::getInferenceTime;
%unignore Solver::Test;
%unignore Solver::createMasterDRL;
%unignore Solver::deleteMasterDRL;
%unignore Solver::setMasterDRL;
%unignore Solver::setConstrStruct;
%unignore Solver::checkIfCaseInPool;
%unignore Solver::retrieveConstrStruct;
%unignore Solver::addConstrStructToPool;
%unignore Solver::setConstrChecker;
%unignore Solver::addConstrChecker;
%unignore Solver::addCheckerAssignment;
%unignore Solver::addCheckerVarMapping;
%unignore Solver::setSolverPhase;
%unignore Solver::takeSnapshot;
%unignore Solver::saveDRLModel;
%unignore Solver::loadDRLModel;
%unignore Solver::saveACEWeights;
%unignore Solver::loadACEWeights;
